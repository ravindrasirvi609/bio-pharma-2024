    ...
    <section className="relative h-screen overflow-hidden">
      ...
      <div className="relative h-full flex items-center justify-center">
        <div className="text-center text-white px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <p className="text-xl sm:text-2xl md:text-3xl mb-6 animate-fadeIn animation-delay-200">
            Shaping the Future of Healthcare
          </p>
          <p className="text-lg sm:text-xl mb-8 animate-fadeIn animation-delay-400">
            August 15-17, 2024 • New York City
          </p>
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4 animate-fadeIn animation-delay-600">
            <Link
              href="/register"
