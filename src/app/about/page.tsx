...
const AboutPage: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <title>About Global BioPharma Webinar Group</title>
        <meta
          name="description"
          content="Learn about the Global BioPharma Webinar Group, a premier international gathering for biopharmaceutical innovation and collaboration."
        />
      </Head>
        ...
        <section className="relative h-[90vh] flex items-center justify-center text-white">
          ...
          <div className="relative z-10 text-center px-4">
            <motion.h1
              ...
              variants={fadeIn}
            >
              Global BioPharma Webinar Group
            </motion.h1>
            <motion.p
        ...
        <section className="py-20 px-4 md:px-8 max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-[#0196c2] mb-8">
              About the Global BioPharma Webinar
            </h2>
            <p className="text-lg text-gray-700 leading-relaxed">
              The Global BioPharma Webinar is a premier international gathering
              designed to bring together the brightest minds, leading
              innovators, and key decision-makers in the biopharmaceutical
              industry. With a focus on the latest advancements in vaccine
              development, immunotherapy, and biotech innovations, this webinar
              serves as a platform for collaboration, knowledge exchange, and
              the fostering of groundbreaking solutions that address the
          ...
          >
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              At the core of the Global BioPharma Webinar is a mission to
          ...
          >
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-8">
              The Global BioPharma Webinar is more than just an event; it&apos;s
              a catalyst for global change. By bringing together diverse
              perspectives and expertise, we strive to create an environment
              where innovative ideas can flourish and lead to tangible
              improvements in global health. Whether you are a researcher
              seeking collaboration, a healthcare provider looking to stay ahead
              of the curve, or an industry leader interested in the next big
              breakthrough, this webinar is your opportunity to make a
              difference.
            </p>
            <p className="text-2xl font-semibold text-[#ec4c5b]">
              Join us at the Global BioPharma Webinar, where science meets
